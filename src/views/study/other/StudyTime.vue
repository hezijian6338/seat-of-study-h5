    ...
    <div id="container">
        ...
        <div class="flex-center">
            <div class="w box1 flex-center">
                <div class="w2">
                    <div class="border"><img class="" src="~assets/imgs/study/clock.png" alt=""></div>
            ...
            <div class="w box2 flex-center">
                <div class="w2">
                    ...
                    <div class="box-item2">
                        <brand :index="0" :currentIndex="currentIndex2" @Btnclick="Btn2click"><span>闭目冥想</span></brand>
                        <brand :index="1" :currentIndex="currentIndex2" @Btnclick="Btn2click"><span>加油!</span></brand>
                        <brand :index="2" :currentIndex="currentIndex2" @Btnclick="Btn2click"><span>数学!!!!</span></brand>
                        <brand :index="3" :currentIndex="currentIndex2" @Btnclick="Btn2click"><span>英语背单词啦</span></brand>
                        <brand :index="4" :currentIndex="currentIndex2" @Btnclick="Btn2click"><span>睡了睡了</span></brand>
                        <brand :index="5" :currentIndex="currentIndex2" @Btnclick="Btn2click"><span>晚安</span></brand>
                        <brand :index="6" :currentIndex="currentIndex2" @Btnclick="Btn2click"><span>gg</span></brand>
                        <brand :index="7" :currentIndex="currentIndex2" @Btnclick="Btn2click"><span>凉凉了</span></brand>
                    </div>
                </div>
            </div>
        </div>
